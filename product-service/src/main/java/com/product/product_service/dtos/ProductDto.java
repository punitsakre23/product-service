...
public class ProductDto implements Serializable {
    ...
    @AssertTrue(message = "When Platform Fee Applicability is 'YES' then" +
    ...
    private boolean isPlatformFeeApplicable() {
        if (isPlatformFeeApplicable.equals(ProductConstant.APPLICABILITY_YES)) {
            return platformFeeThresholdLimit != null && platformFeeThresholdLimit >= 0 &&
                    lowerPlatformFee != null && lowerPlatformFee >= 0 &&
                    higherPlatformFee != null && higherPlatformFee >= 0;
        }
        return true;
    }
}
